...
The next part what I want to do is to label the rows with genuine and not by searching for the words "Superlatives" and the review length and then run a neural network model on the labeled dataset and find the suspicious review.
